...
public class ControladorVentanaInformeEntrada implements Initializable {
    ...
    public void MostradorDeDatos(String Semestre, String Grup){
        ...
        try {
            ...
            String query = "SELECT Nombre, Grado, Grupo, Matricula, Fecha, Hora, Reporte, ReporteDos, ReporteTres, Descripcion FROM registros WHERE Grado = ? AND Grupo = ?";
            ...
            while (resultSet.next()) {
                ...
                users.add(new datos(nombre, grado, grupo, matricula, fecha, hora, reporte, reporteDos, reporteTres, descripcion));
            }
